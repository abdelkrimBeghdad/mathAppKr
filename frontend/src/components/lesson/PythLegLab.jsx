...
function PythLegContent({ phase, setPhase }) {
    ...
    return (
        <LabChallenge
            ...
            tourSteps={[
                { target: 'pyth-triangle-svg', title: 'مثلث بضلع مجهول', description: 'هذه المرة المجهول ليس الوتر، بل أحد الضلعين القائمين.' },
                { target: 'lab-answer-input', title: 'حقل الإجابة', description: 'اعكس العملية: اطرح مربع الضلع المعلوم من مربع الوتر، ثم استخرج الجذر التربيعي.' },
