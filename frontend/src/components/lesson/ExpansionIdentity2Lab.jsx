...
function ExpansionIdentity2Content({ phase, setPhase }) {
    ...
    return (
        <LabChallenge
            ...
            tourSteps={[
                { target: 'lab-question', title: 'مربع الفرق', description: 'المطابقة (x−b)² = x² − 2bx + b² ثابتة دائماً.' },
                { target: 'lab-answer-input', title: 'حقلا الإجابة', description: 'الحد الأوسط سالب دائماً (طرح)، والحد الأخير موجب دائماً (مربع b).' },
